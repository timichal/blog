...
### Plán
{% include img.html path="2024-04-06/narvik-lisabon-mapa" nosm="true" cls="float-right" %}
...
### Den 0: Do Narviku
{% include img.html path="2024-04-06/viden" cls="float-left" caption="Nádraží ve Vídni. Hezké." %}
...
{% include img.html path="2024-04-06/narvik" cls="float-right" caption="Polární noc na nádraží v Narviku." %}
...
{% include img.html path="2024-04-06/narvik-kiruna-mapa" nosm="true" cls="float-right" caption="Autentický popis situace odeslaný z Riksgränsenu." %}
...
{% include img.html path="2024-04-06/kiruna" cls="float-left" caption="Socha stavitelů železnice v Kiruně vyfocená lehce omrzlým mobilem." %}
...
{% include img.html path="2024-04-06/boden" cls="float-right" caption="Mrazivý přestup v Bodenu." %}
...
{% include img.html path="2024-04-06/stockholm" cls="float-left" caption="Vánoční Stockholm." %}
...
{% include img.html path="2024-04-06/stockholm-x2000" cls="float-right" caption="Vlak X 2000 vyráží ze Stockholmu." %}
...
{% include img.html path="2024-04-06/hamburg" cls="float-left" caption="Obří a ne moc příjemné hamburské nádraží." %}
...
{% include img.html path="2024-04-06/frankfurt" cls="float-left" caption="Dojemný betlém na nádraží ve Frankfurtu." %}
...
{% include img.html path="2024-04-06/pariz" cls="float-right" caption="Paříž - Užhorod západu." %}
...
{% include img.html path="2024-04-06/pariz-tgv" cls="float-left" caption="Dav nastupující do TGV na pařížském Montparnasse." %}
...
{% include img.html path="2024-04-06/san-sebastian" cls="float-right" caption="Deštivý San Sebastián." %}
...
{% include img.html path="2024-04-06/zumarraga" cls="float-right" caption="Přestup v Zumárraze z autobusu na španělský rychlovlak." %}
...
{% include img.html path="2024-04-06/madrid" cls="float-left" caption="Palmy na madridském nádraží." %}
...
{% include img.html path="2024-04-06/merida" cls="float-right" caption="Ruiny akvaduktu v Méridě postaveného starověkými Římany. Okno dodává estetický filtr." %}
...
{% include img.html path="2024-04-06/badajoz" cls="float-left" caption="Vodnická portugalská lokálka z Badajozu do Entroncamenta." %}
...
{% include img.html path="2024-04-06/portalegre" cls="float-right" caption="Malebné nádraží v Portalegre u portugalských hranic se Španělskem." %}
...
{% include img.html path="2024-04-06/lisabon" cls="float-left" caption="Noční Lisabon." %}
